...
func (ns *nodeServer) NodePublishVolume(ctx context.Context, req *csi.NodePublishVolumeRequest) (*csi.NodePublishVolumeResponse, error) {
	...
	// root cannot redirect the mount outside it. Skipped on Windows hosts
	// (unit tests): EvalSymlinks returns host-style paths there, and the
	// real sandbox always runs Linux.
